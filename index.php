...
<div id="right_panel">
  <button type="button" class="btn btn-danger btn-sm" aria-label="Left Align" id="showRibbonMenuBtn" data-toggle="modal" data-target="#myModal">
    <span class="glyphicon glyphicon-align-left" aria-hidden="true"></span>
  </button>

  <div class="modal fade menuModalHeight" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog menuModalHeight" role="document">
